  ...
  "inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors lg:hover:bg-muted lg:hover:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=on]:bg-sky-300/70 data-[state=on]:text-accent-foreground",
  {
    variants: {
      variant: {
        ...
        filled:
          "border-solid border border-input bg-background lg:hover:bg-accent lg:hover:text-accent-foreground",
      },
      size: {
        default: "h-20 w-20 px-3",
        sm: "h-9 px-2.5",
        lg: "h-11 px-5",
      },
    },
